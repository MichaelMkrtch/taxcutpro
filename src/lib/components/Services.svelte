...
<div class="mt-6 bg-[#EAEAEC] py-16">
	<section id="services" class="section-container">
		<div class="flex items-center justify-between">
			<!-- <h2 class="section-header">Services</h2> -->
			<!-- <p class="font-medium text-gray-600">We deliver clear financial solutions</p> -->
		</div>
		...
		<section class="mx-auto mt-8 flex rounded-lg border border-[#C9C9CF] bg-[#DFDFE2] text-lg">
			...
			>
				<div class="flex items-center gap-2 text-[#1C9B4B]">
					<Landmark />
			...
			>
				<div class="flex items-center gap-2 text-[#1C9B4B]">
					...
					<h3 class="text-xl font-medium">Advisory</h3>
				</div>
				<p class="mt-6 text-pretty leading-7">
