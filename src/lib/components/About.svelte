<div class="mt-16 bg-[#EDEBE8] py-16 dark:bg-[#1a1a1a]">
	<section id="about" class="section-container">
		...
		<p class="mt-8 w-4/5 text-pretty text-lg font-medium leading-7 tracking-wide">
			...
			eius nihil, accusamus possimus nostrum numquam inventore recusandae reprehenderit voluptatibus
			odio in, dolorem animi id nesciunt velit? Placeat voluptate omnis ratione libero aliquam amet.
			Maiores, porro libero? Porro ipsa, facere a, repudiandae fugit impedit nam quaerat iusto fuga
			in odit et harum nobis itaque distinctio. Cumque qui delectus quibusdam exercitationem enim
			deserunt repellendus nesciunt!
		</p>
	</section>
</div>
