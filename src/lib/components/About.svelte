<div
	class="mt-9 rounded-lg bg-[#EDEBE8] px-7 py-9 dark:bg-[#1a1a1a] md:my-10 md:rounded-none md:px-0 md:py-16"
>
	<section id="about" class="section-container">
		<h2 class="section-header text-[#127453] dark:text-[#199F72]">About Us</h2>
		<p class="mt-8 w-full text-pretty text-lg font-medium leading-7 tracking-wide md:w-4/5">
			...
			odio in, dolorem animi id nesciunt velit.
		</p>
	</section>
</div>
